...
```jsonc
{
  ...
  "by_run": [                              // one entry per (arm, world, seed, buyer_kind)
    {
      ...
      "row_kind": "policy"|"llm_real"|"llm_fallback"|"llm_failed"|"llm_skipped",
      "row_status": "completed"|"fallback"|"failed"|"skipped",
      "total_spend": float,
  ...
  "llm_lane_accounting": {
    "policy_rows": int,
    "real_llm_rows": int,
    "deterministic_fallback_rows": int,
    "failed_llm_rows": int,
    "skipped_llm_rows": int
  },
  "proof_readiness": {
...
skipped rows are accounted separately and never count as real LLM evidence.
