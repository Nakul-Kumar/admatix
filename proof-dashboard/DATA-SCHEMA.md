...
```ts
type DataOriginKind =
  | "live"        // current production endpoint or verified live extract
  | "artifact"    // immutable CX-2/CX-3/CX-4 artifact bundle
  | "demo"        // bundled synthetic dashboard sample
  | "fixture"     // deterministic local fixture output
  | "unavailable";
