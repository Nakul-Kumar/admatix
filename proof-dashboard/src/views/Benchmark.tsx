    ...
    <Card
      ...
      actions={
        <div className="row" style={{ gap: 6 }}>
          ...
          <OriginBadge origin={origin} dataset={`Arm ${arm.id}`} compact />
        </div>
      }
    >
...
export function Benchmark() {
  ...
  if (data.status === "error") {
    return (
      <div className="page">
        <OriginSummary items={[{ dataset: "Benchmark", origin: data.origin }]} />
        <UnavailablePanel
          dataset="Benchmark"
          message={data.error}
          origin={data.origin}
  ...
  return (
    <div className="page">
      ...
      <OriginSummary items={[{ dataset: "Benchmark", origin: data.data.origin }]} />
      ...
      <section className="grid cols-2">
        {arms.map((a) => (
          <ArmCard key={a.id} arm={a} origin={data.data.origin} />
        ))}
      </section>
    </div>
  );
